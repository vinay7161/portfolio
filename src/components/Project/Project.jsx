...
import Aiimg from "../../assets/ProjectsImg/ai.png";
import truck from "../../assets/ProjectsImg/truck.png";
import RedBusImg from "../../assets/ProjectsImg/redbus.png";
...
const projects = [
  {
    ...
    description:
      "A modern AI-powered recruitment platform designed to simplify hiring processes including applicant tracking, interview scheduling, candidate management, and onboarding. Developed responsive and user-friendly interfaces using modern frontend technologies to enhance user experience and workflow efficiency.",
    link: "https://www.kretsia.com/",
    image: Aiimg,
    tech: ["React", "Next.js", "Tailwind CSS", "JavaScript", "Framer Motion"],
  },
  {
    title: "Trafficology Logistics",
    description:
      "A modern and responsive logistics website built for a transportation and supply chain company. The website showcases logistics services such as freight transportation, warehousing, shipment tracking, and supply chain solutions with a clean UI, responsive design, and smooth user experience.",
    link: "https://www.trafiicologylogistics.com/",
    image: truck,
    tech: [
      "React",
      "Next.js",
  ...
  },
  {
    title: "Red Bus Clone",
    description:
      "A bus ticket booking web application inspired by RedBus, built using React and modern UI libraries. It allows users to search buses, view available routes, select seats, and simulate the booking process with a clean and responsive interface.",
    link: "https://red-bus-virid.vercel.app/",
    image: RedBusImg,
